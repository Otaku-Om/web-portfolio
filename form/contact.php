...
$emailTO[] = array('email' => 'saxenaom12@gmail.com', 'name' => 'Om Saxena');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST["cf_email"]) && $_POST["cf_email"] != '' && isset($_POST["cf_name"]) && $_POST["cf_name"] != '') {
        ...
        $cf_subject = isset($_POST["cf_subject"]) ? $_POST["cf_subject"] : '';
        ...
        if ($honeypot == '' && !(empty($emailTO))) {
            ...
            $mail->Username = 'saxenaom12@gmail.com'; // Your Gmail address
            $mail->Password = 'MinatoNamikaze'; // Your Gmail password or app password
